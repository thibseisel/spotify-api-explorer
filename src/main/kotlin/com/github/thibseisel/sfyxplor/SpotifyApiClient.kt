...
internal class Payload<T>(val data: T)
...
@TestOnly constructor(
    ...
    override suspend fun getSeveralArtists(ids: List<String>): List<Artist?> {
        ...
        val wrapper = spotifyService.get<JsonWrapper<Artist?>>("/v1/artists") {
    ...
    override suspend fun getSeveralAlbums(ids: List<String>): List<Album?> = spotifyService.get("/v1/albums") {
    ...
    override suspend fun getSeveralTracks(ids: List<String>): List<Track?> = spotifyService.get("/v1/tracks") {
        require(ids.size in 0..50)
    ...
    override suspend fun getSeveralTrackFeatures(trackIds: List<String>): List<AudioFeatures?> =
        spotifyService.get("/v1/audio-features") {
